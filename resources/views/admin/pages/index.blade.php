...
<div class="stat-card rounded-3xl overflow-hidden">
    <table class="w-full text-sm">
        <thead class="bg-sand text-start"><tr><th class="p-3 text-start">Title</th><th class="p-3">Slug</th><th class="p-3">Locale</th><th class="p-3">Status</th><th></th></tr></thead>
        <tbody>
            @foreach ($pages as $page)
                <tr class="border-t border-forest/10">
                    <td class="p-3">{{ $page->title }}</td>
                    <td class="p-3">/p/{{ $page->slug }}</td>
